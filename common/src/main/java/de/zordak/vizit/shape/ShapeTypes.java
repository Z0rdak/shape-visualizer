...
import de.zordak.vizit.shape.strategy.*;
...
public class ShapeTypes {
    ...
    public static final ResourceKey<Registry<ShapeType<?>>> SHAPE_TYPE_REGISTRY_KEY =
            ResourceKey.createRegistryKey(ResourceLocation.fromNamespaceAndPath(Constants.MOD_ID, "shape_types"));
    ...
    public static <T extends Shape> ShapeType<T> register(ShapeType<T> shapeType) {
        return Registry.register(REGISTRY, ResourceLocation.fromNamespaceAndPath(Constants.MOD_ID, shapeType.id()), shapeType);
    }
}