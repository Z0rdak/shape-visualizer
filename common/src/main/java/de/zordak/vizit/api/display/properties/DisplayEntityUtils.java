...
import de.zordak.vizit.VizItCommon;
...
import static de.zordak.vizit.api.display.properties.DisplayProperties.TAG_BRIGHTNESS;
import static de.zordak.vizit.api.display.properties.DisplayProperties.TAG_GLOW_COLOR;
...
public class DisplayEntityUtils {
    ...
    public static <D extends Display> D setCustomData(D entity, CompoundTag dataTag) {
        return setCustomData(entity, Constants.TAG_DEFAULT_CUSTOM_DATA, dataTag);
    }
    ...
    public static <D extends Display> D setGlowColor(D entity, ChatFormatting glowColor) {
        ...
        tag.putInt(TAG_GLOW_COLOR, color);
    ...
    public static <D extends Display> D setBrightness(D entity, int lightLevel) {
        ...
        tag.put(TAG_BRIGHTNESS, brightnessTag);
